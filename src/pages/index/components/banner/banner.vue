<template>
  <section class="banner-container" id="banner">
    ...
    <a href="javascript:;" class="common-btn android hide-xs" @click.stop="showQrCode('android')">
      <i></i>
      {{$t('HEADER.ANDROID_DOWNLOAD')}}
    </a>
    <a href="javascript:;" class="common-btn ios hide-xs" @click.stop="showQrCode('ios')">
      <i></i>
